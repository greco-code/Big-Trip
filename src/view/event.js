...
const createEventTemplate = (event) => {
  ...
  const timeStart = humanizeToTime(dateFrom);
  const timeFinish = humanizeToTime(dateTo);
  const eventDay = humanizeToMonthDay(dateFrom);

  const isInFavorites = isFavorite ? 'event__favorite-btn--active' : '';
  ...
  return `<div class="event">
            ...
            <button class="event__favorite-btn ${isInFavorites}" type="button">
