...
import {getDestinations} from './destinations-data.js';
...
export const generateEvent = () => {
  ...
  const destination = getDestinations()[getRandomInteger(0, getDestinations().length - 1)];
  const offers = getOffers()[getRandomInteger(0, getOffers().length - 1)];
